...
st.dataframe(df_racer.style.highlight_max(color='Lightgreen', axis=0,subset=['Speed','Acceleration','Weight','Handling','Traction/Grip','Mini-Turbo','Times First Place', 'Total Races'])
